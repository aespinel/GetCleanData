CodeBook for the tidy dataset tidy1.txt
Data source

This dataset is derived from the "Human Activity Recognition Using Smartphones Data Set" which was originally available in:
