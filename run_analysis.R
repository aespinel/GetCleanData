...
# Read features and make the feature names more clear for R with substitutions 
...
# Remove the subject and activity column, because no mean of those has effect
tidy[,90] = NULL
tidy[,89] = NULL
